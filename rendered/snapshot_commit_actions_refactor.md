# Snapshot Commit Refactor — Action Commands as Canonical Mutation Ingress

## EP 0

**Normative**: Yes

**WHY**: Snapshot commit is a canonical mutation: it appends to the ledger, writes manifest bytes to CAS, and
...
**WHAT**: Refactor snapshot_commit so that:
...
**HOW**: Scenarios (all MUST be implemented as tests; Gherkin is normative):
